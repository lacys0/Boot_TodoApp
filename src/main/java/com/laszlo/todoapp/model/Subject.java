...
public class Subject {
    ...
    // cascade = CascadeType.ALL means operations (like delete) on Subject will cascade to associated TodoItems
    // orphanRemoval = true means if a TodoItem is disassociated from a Subject, it will be removed from the DB
    @OneToMany(mappedBy = "subject", cascade = jakarta.persistence.CascadeType.ALL, orphanRemoval = true)
